...
int WINAPI WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPSTR lpCmdLine, _In_ int nCmdShow)
{
	...
	while (ProcessMessage() == 0 && CheckHitKey(KEY_INPUT_ESCAPE) == 0)
	{
		...
		/*Vector3 disection1 = { 1.0f,0.0f,1.0f };
		Vector3 disection2 = { 1.0f,1.0f,0.0f };
		Quaternion dirToDir = DirectionToDirection(disection1, disection2);*/
		...
		//DrawFormatString(3, 10, GetColor(0, 0, 0), "(x:%.2f,y:%.2f,z:%.2f.w:%.2f)", dirToDir.x, dirToDir.y, dirToDir.z, dirToDir.w);
